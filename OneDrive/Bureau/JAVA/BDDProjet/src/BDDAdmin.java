...
public class BDDAdmin extends JFrame {
	...
	public BDDAdmin() {
		...
		Privilege.setBounds(190, 145, 320, 40);
		...
		lblNewLabel_1.setBounds(70, 150, 110, 40);
		BddAdmin.add(lblNewLabel_1);
		
		final JComboBox Table = new JComboBox();
		Table.setEditable(true);
		Table.setBounds(190, 228, 320, 40);
		BddAdmin.add(Table);
		...
		lblNewLabel_2.setBounds(70, 224, 110, 40);
		...
		JRadioButton Requete = new JRadioButton("Consulter les resultats des requetes");
		...
		Requete.setFont(new Font("Tahoma", Font.BOLD, 16));
		Requete.setBounds(70, 91, 340, 23);
		BddAdmin.add(Requete);
